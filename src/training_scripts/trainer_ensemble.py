...
from src.models.ensemble_lightning_module import EnsembleLightning
...
def main(hparams):
    ...
    model = EnsembleLightning(config, training_run_name=wandb_logger.name)
